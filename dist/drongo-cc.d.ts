import { Color, Vec2, Component, Node, Mask, Constructor, EventTarget, Event as Event$2, Size, Sprite, Rect, SpriteFrame, AssetManager, Asset, dragonBones, UITransform, UIOpacity, Label, Font, LabelOutline, LabelShadow, HorizontalTextAlignment, VerticalTextAlignment, Graphics, sp, RichText, AudioClip, EditBox } from 'cc';
